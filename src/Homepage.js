    ...
    getEmptyApplicationsDiv = () => {
        return(
            <div className="empty_page">
                ...
                <em data-emoji="anguished" class="big"></em>
            </div>
        );
    }
